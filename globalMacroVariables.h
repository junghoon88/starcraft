...
#define TEXTCOLOR_MYRESOURCE		RGB(14, 246, 23)
#define TEXTCOLOR_MYRESOURCE_ERROR	RGB(198, 24, 24)

#define TEXTCOLOR_UNITNAME		RGB(179, 179, 224)
#define TEXTCOLOR_DETECTOR		RGB(218, 218, 60)
#define TEXTCOLOR_UNITHP		RGB(17, 248, 25)
#define TEXTCOLOR_UNITMP		RGB(255, 255, 255)

#define MINIMAPCOLOR_NEUTRAL	RGB(0, 228, 252)
#define MINIMAPCOLOR_MYOBJCT	RGB(16, 252, 24)
#define MINIMAPCOLOR_ENEMY		RGB(244, 4, 4)

#define TIMECOLOR				RGB(186, 186, 235)
...
#define ICONWEAPON_WIDTH	36
#define ICONWEAPON_HEIGHT	36
...
enum COMMAND
{
	...
	//EVOLUTION
	COMMAND_EVOLUTION_ZERG_BURROW,					//저그 버러우 업글
	...
	COMMAND_EVOLUTION_ZERG_LURKER_ASPECT,			//럴커 업글
	COMMAND_EVOLUTION_ZERG_SPAWN_BROODLING,			//퀸 브루드링 업글
	COMMAND_EVOLUTION_ZERG_ENSNARE,					//퀸 인스테어 업글
	COMMAND_EVOLUTION_ZERG_GAMETE_MEIOSIS,			//퀸 마나업
	COMMAND_EVOLUTION_ZERG_ANABOLIC_SYNTHESIS,		//울트라 이속업
	COMMAND_EVOLUTION_ZERG_CHITINOUS_PLATING,		//울트라 방업(+2)
	COMMAND_EVOLUTION_ZERG_PLAGUE,					//디파일러 플레이그
	COMMAND_EVOLUTION_ZERG_CONSUME,					//디파일러 컨슘
...
enum PENVERSION
{
	...
	PENVERSION_RESOURCECLICK,
	PENVERSION_SHOWGASRECT,
...
enum EVOLUTION_ZERG
{
	EVOLUTION_ZERG_BURROW,					//저그 버러우 업글
	...
	EVOLUTION_ZERG_LURKER_ASPECT,			//럴커 업글

	EVOLUTION_ZERG_SPAWN_BROODLING,			//퀸 브루드링 업글
	EVOLUTION_ZERG_ENSNARE,					//퀸 인스테어 업글
	EVOLUTION_ZERG_GAMETE_MEIOSIS,			//퀸 마나업

	EVOLUTION_ZERG_ANABOLIC_SYNTHESIS,		//울트라 이속업
	EVOLUTION_ZERG_CHITINOUS_PLATING,		//울트라 방업(+2)

	EVOLUTION_ZERG_PLAGUE,					//디파일러 플레이그
	EVOLUTION_ZERG_CONSUME,					//디파일러 컨슘
